...
- [1. 基本概念](#1-基本概念)
    - [1.1. 关系型数据库OR非关系型数据库](#11-关系型数据库or非关系型数据库)
    - [1.2. 数据库系统](#12-数据库系统)
    - [1.3. 为什么需要DB](#13-为什么需要db)
    - [1.4. 表](#14-表)
        - [1.4.1. 行](#141-行)
    - [1.5. SQL](#15-sql)
- [2. MySQL](#2-mysql)
- [3. 使用MySQL](#3-使用mysql)
    - [3.1. 连接](#31-连接)
        - [3.1.1. 简单的mysql命令](#311-简单的mysql命令)
- [4. SQL语句](#4-sql语句)
    - [4.1. 检索单个列](#41-检索单个列)
    - [4.2. 检索多个列](#42-检索多个列)
        - [4.2.1. 检索所有列](#421-检索所有列)
    - [4.3. 检索distinct的行](#43-检索distinct的行)
    - [4.4. 限制结果](#44-限制结果)
...
<a id="markdown-11-关系型数据库or非关系型数据库" name="11-关系型数据库or非关系型数据库"></a>
## 1.1. 关系型数据库OR非关系型数据库
...
<a id="markdown-13-为什么需要db" name="13-为什么需要db"></a>
## 1.3. 为什么需要DB
...
<a id="markdown-311-简单的mysql命令" name="311-简单的mysql命令"></a>
### 3.1.1. 简单的mysql命令
...
<a id="markdown-43-检索distinct的行" name="43-检索distinct的行"></a>
## 4.3. 检索distinct的行
